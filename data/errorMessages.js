...
const NOT_FOUND_MOVIE_CARD_ERROR_RU = 'Карточка с фильмом не найдена.';
const NOT_FOUND_DEFAULT_ERROR_RU = 'Страница по указанному маршруту не найдена.';
const LIMITTER_ERROR_RU =
  'Слишком много запросов с одного IP. Попробуйте позже.';
const AUTHORIZATION_REQUIRED_ERROR_RU = 'Необходима авторизация.';
const AUTHORIZATION_WRONG_ERROR_RU = 'Вы ввели неправильный логин или пароль.';
